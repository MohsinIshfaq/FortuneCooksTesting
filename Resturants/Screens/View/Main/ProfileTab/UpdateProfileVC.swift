    ...
    func setupUserData(){
        ...
        if let profile = self.profileModel {
            ...
            if !(profile.timings?.isEmpty ?? false){
                txtMondayOpening.text    = profile.timings?[0] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[0] ?? "")?.0
                txtMondayClosing.text    = profile.timings?[0] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[0] ?? "")?.1
                ...
                txtTuesdayOpening.text   = profile.timings?[1] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[1] ?? "")?.0
                txtTuesdayClosing.text   = profile.timings?[1] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[1] ?? "")?.1
                ...
                txtWednesdayOpening.text = profile.timings?[2] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[2] ?? "")?.0
                txtWednesdayClosing.text = profile.timings?[2] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[2] ?? "")?.1
                ...
                txtThrusdayOpening.text  = profile.timings?[3] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[3] ?? "")?.0
                txtThrusdayClosing.text  = profile.timings?[3] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[3] ?? "")?.1
                ...
                txtFridayOpening.text    = profile.timings?[4] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[4] ?? "")?.0
                txtFridayClosing.text    = profile.timings?[4] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[4] ?? "")?.1
                ...
                txtSaturdayOpening.text  = profile.timings?[5] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[5] ?? "")?.0
                txtSaturdayClosing.text  = profile.timings?[5] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[5] ?? "")?.1
                ...
                txtSundayOpening.text    = profile.timings?[6] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[6] ?? "")?.0
                txtSundayClosing.text    = profile.timings?[6] == "Closed" ? "00:00" : splitTimeRange(profile.timings?[6] ?? "")?.1
