...
class CustomTabBar: UITabBar {
    ...
    public lazy var middleButton: UIButton! = {
        ...
        middleButton.frame.size = CGSize(width: 100, height: 45)
        middleButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0)
...
//        middleButton.tintColor = .black
    ...
    override func layoutSubviews() {
        ...
        middleButton.center = CGPoint(x: frame.width / 2, y: 26)
    }
